...
showMobilePhoneWidget(context){
  return Column(
    ...
    children: [
      Spacer(),
      Text("Please Enter your mobile number" , style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
      Text("You'll recive a 4 digit code" , style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
      Text("to verify next" , style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
      SizedBox(height: 7,),
      SizedBox(height: 20,),
      Center(
        child:       TextField(
...
showOtpFormWidget(context){
  return Column(
    ...
    children: [
      Spacer(),
      Text("Verify Phone" , style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
      SizedBox(height: 7,),
      SizedBox(height: 20,),
      Center(
        child:       TextField(
